  ...
  const milestones = [
    ...
    },
    {
      ...
      contents: [
        {
          id: 1,
          text: "서비스명/등록된 새이슈 내용과 병합",
          time: "2026-04-29 14:23:01",
        },
        {
          id: 2,
          text: "In Progress -> To do 로 변경",
          time: "2026-04-29 14:23:05",
        },
        {
          id: 3,
          text: "작업라인에서 새 이슈가 등록",
          time: "2026-04-29 14:23:10",
        },
      ],
    },
  ];
  ...
  return (
    <div className="flex-1 bg-black min-h-screen p-10 text-white selection:bg-[#00FFA3] selection:text-black">
      ...
      <div className="flex justify-between items-center">
        <div className="mb-12">
          <h2 className="text-3xl font-[700] tracking-tighter uppercase text-white">
            {viewDate.getFullYear()}. {viewDate.getMonth() + 1}
          </h2>
          <p className="text-[12px] text-gray-500 font-bold tracking-widest mt-1 uppercase">
            타임라인 별 작업을 확인해보세요
          </p>
        </div>
        ...
        <div className="flex items-center bg-[#111] border border-white/5 rounded-2xl p-1 shadow-xl">
          <button
            ...
            className="p-3 hover:bg-white/5 rounded-xl transition-colors text-gray-400"
          >
            <ChevronLeft size={18} />
          </button>
          <button
      ...
      <div className="border border-white/[0.03] rounded-3xl bg-[#0D0D0D] shadow-[0_30px_60px_rgba(0,0,0,0.6)] overflow-hidden">
        ...
        >
          ...
          >
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[8px] opacity-60 uppercase font-mono">
                      {viewDate.toLocaleString("en-US", { month: "short" })}
                    </span>
                  </div>
                );
              })}
            ...
            {/* 카드 및 그리드 영역 */}
            <div className="relative p-10 flex flex-col gap-6 min-h-[650px] animate-in fade-in slide-in-from-bottom-2 duration-500">
              {/* 그리드 가이드라인 (세로선) */}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/* 이미지 컨셉의 네온 도트 */}
                        <div
                          className={`w-1.5 h-1.5 rounded-full mr-3 shadow-lg ${isExpanded ? "bg-[#00FFA3] shadow-[#00FFA3]" : "bg-gray-600"}`}
                        />

                        <span
                          className={`text-[11px] font-black uppercase tracking-tight truncate flex-1 
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          <span
                            className={`text-[10px] transition-transform duration-300 ${isExpanded ? "rotate-180 text-[#00FFA3]" : "text-gray-600"}`}
                          >
                            ▼
                          </span>
                        </div>
                      ...
                      {isExpanded && m.contents && (
                        <div className="bg-black/40 animate-fadeIn border-t border-white/[0.03]">
                          {m.contents.map((c) => (
                            <div
                              key={c.id}
                              className="flex justify-between items-center p-4 border-b border-white/[0.02] last:border-0 hover:bg-white/[0.01] transition-colors"
                            >
                              <div className="flex items-center gap-3 text-[11px]">
                                <span className="text-[#00FFA3] opacity-60">
                                  🐙
                                </span>
