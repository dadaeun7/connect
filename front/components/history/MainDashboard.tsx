    ...
    <div className="flex-1 bg-black min-h-screen p-10 text-white font-sans selection:bg-[#00FFA3] selection:text-black">
      ...
      <div className="flex justify-between items-start mb-12">
        ...
        <div className="flex gap-3 scale-80">
          ...
          <button
            className="bg-[#00FFA3] text-black font-black px-5 py-3 rounded-l hover:scale-105 active:scale-95 transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(0,255,163,0.2)] text-sm uppercase"
            onClick={oepnModal}
          >
            + Create Task
          </button>
