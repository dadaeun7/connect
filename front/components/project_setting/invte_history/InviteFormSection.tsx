...
import { CurrentProjectRolesResponse } from "../api/affiliation";
import { useInviteFormSection } from "../hooks/useInviteFormSection";
...
export default function InviteFormSection({
  ...
  const { loading, alertConfig, email, setEmail, role, setRole, inviteSubmit } =
    useInviteFormSection();
