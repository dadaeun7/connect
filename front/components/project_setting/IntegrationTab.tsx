...
export default function IntegrationTab() {
  ...
  return (
    <div className="flex-1 bg-black min-h-screen p-10 text-white">
          ...
          <div className="lg:col-span-2 bg-[#111111] border border-white/5 rounded-3xl p-8 relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="bg-[#00FFA3] text-black text-[9px] font-black px-2 py-0.5 rounded uppercase">
                  Connected
                </span>
              </div>
              ...
              {/* 자사 developer 연동*/}
              <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mt-5">
                MarketPlace
                <span className="ml-3 bg-[#00FFA3] text-black text-[9px] font-black px-2 py-0.5 rounded uppercase">
                  beta
                </span>
              </label>
              <div className="text-[12px] text-gray-500 mt-1 mb-2">
                직접 ID, Secret 발급없이 연동이 가능합니다. 사용량에 따라 요금이
                과금됩니다.
              </div>
